  ...
  return (
    <div className="flex min-h-screen w-full bg-slate-50 dark:bg-slate-950">
      ...
      <div className="flex-1 flex flex-col min-w-0">
        ...
        <header className="sticky top-0 z-30 flex items-center justify-between px-4 sm:px-6 py-2.5 border-b border-slate-200/80 dark:border-slate-800 bg-white/90 dark:bg-slate-900/90 backdrop-blur-xl">
          {/* Logo en móvil cuando el sidebar está oculto */}
        ...
        <main className="flex-1 min-w-0 max-w-7xl w-full mx-auto px-3 sm:px-5 lg:px-6 py-4 sm:py-5 space-y-4 sm:space-y-5">
        {/* BANNER ONBOARDING */}
